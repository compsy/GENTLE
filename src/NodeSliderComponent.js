...
class NodeSliderComponent extends Component {
  ...
  componentDidMount () {
    const updateValue = this.props.sliderUpdateValue
      ...
      <HashRouter>
        <div>
          ...
          <div className='container' id='userInputStd'>
            ...
            <input className='slider' type='range' min='1' max='100' value={this.state.value} onChange={this.updateSlider.bind(this)} />
            <NavLink
              id='confirm_link'
